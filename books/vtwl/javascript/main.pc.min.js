...
setLimited:function(){this.islimited=!0;var a=getLanguage("accessLimitedText","The book is protected. Please purchase it, or verify password / your email to continue reading.");a=$('<div class=\'access-limited-tips\'>\n        <p class=\'access-limited-text\' tabindex="0" aria-live="polite" aria-atomic="true" role="region"  >'+a+"</p>\n      </div>");this.boxContent.append(a);a.css({display:"flex",alignItems:"center",justifyContent:"center",lineHeight:"1.5"})},initTextContent:function(){var a=this;
try{var b=function(){new AnalysisSearch("",function(c,d){d?a.setLimited():(a.clearLimited(),c=BookInfo.getCurrentPages()||1,a.textSectionRenderer.setTextSection(c))})};this._eventBound||(BookEvent.bindOnceEvent("fillBookRestrict",function(c,d){b()}),this._eventBound=!0);b()}catch(c){}},initEvent:function(){var a=this;BookEvent.bindEvent("flipPage",function(b,c,d,e){var f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){a.pageNum&&a.pageNum.find(".access-dest-page").text(d);
f=d.split("-");if(!f||!f.length)return h.return();a.flipPageEvent(f);return h.yield(a.textSectionRenderer.setTextSection(f),2)}null==(g=a.textSection.find("p")[0])||g.focus();h.jumpToEnd()})});this.closeBtn.on(_event._click,function(b){b.stopPropagation();a.hide()});this.sizeDownBtn.on(_event._click,throttle(this.sizeFontSizeFun.bind(this,!1),300));this.sizeUpBtn.on(_event._click,throttle(this.sizeFontSizeFun.bind(this,!0),300));this.previousPage.on(_event._click,throttle(this.flipPageFun.bind(this,
!1),300));this.nextPage.on(_event._click,throttle(this.flipPageFun.bind(this,!0),300));this.handleBoxDrag({$el:this.accessBox[0],parent:this.parent})},flipPageEvent:function(a){a&&a.length&&(this.toggleButtonState(this.previousPage,1!==parseInt(a[0])),this.toggleButtonState(this.nextPage,!(parseInt(a[0])==bookConfig.totalPageCount||parseInt(a[1])==bookConfig.totalPageCount)))},sizeFontSizeFun:function(a){var b=parseInt(this.textSection.css("font-size"))||16,c=a?7:-7;b+=c;(a?30<b:16>b)||(this.toggleButtonState(this.sizeDownBtn,
16<=b+c),this.toggleButtonState(this.sizeUpBtn,30>=b+c),this.textSection.css("font-size",b+"px"),BookEvent.trigger("customEvent",[a?"click_accessibility_increase_font_size":"click_accessibility_decrease_font_size"]))},toggleButtonState:function(a,b){b?(a.attr("tabindex","0"),a.removeClass("access-btn-inactive")):(a.attr("tabindex","-1"),a.addClass("access-btn-inactive"))},flipPageFun:function(a){BookEvent.trigger("customEvent",[a?"click_accessibility_next_page":"click_accessibility_prev_page"]);a?
nextPageFun("accessibility"):previousPageFun("accessibility")},showOrHide:function(){this.visible?this.hide():this.show()},show:function(){this.visible||(this.visible=!0,this.accessBox.addClass("access-box-active"),this.accessBtn.attr("aria-expanded","true"),FormManager.register(this),globalThis.activeButton=this.accessBtn[0],this.accessBox[0].focus())},hide:function(){this.visible&&(this.visible=!1,this.accessBox.removeClass("access-box-active"),this.accessBtn.attr("aria-expanded","false"),this.accessBtn[0].focus(),
FormManager.unregister(this))},onResize:function(){},changeLanguage:function(a){this.previousPage.text(getLanguage("previousPageBtn","Previous page"));this.nextPage.text(getLanguage("nextPageBtn","Next page"));this.headText.text(getLanguage("accessibilityTitle","Text version of the book"));this.pageNum.find(".access-page-num-text").text(getLanguage("accessPageNum","Page"));this.boxContent.find(".access-limited-text").text(getLanguage("accessLimitedText","The book is protected. Please purchase it, or verify password/your email to continue reading."))}});
...
function main(){if(isBelowIE9())alert(getLanguage("infNotSupportHtml5","Your browser can not support HTML5."));else if(global.bookConfig){initBrowserType();initConfig();if(window.userInfo&&bookConfig.isBookDomainAccessEnabled){var a=!1;try{a=document.referrer&&-1<document.referrer.indexOf("/bookcase/")}catch(e){}if(!a){a=window.userInfo.f;var b=null!=window.userInfo.url?window.userInfo.url:window.userInfo.l;try{if(a&&Array.isArray(a)&&0!==a.length&&!a.includes(window.location.hostname)){if(2==b&&
a[0]){var c=window.location.pathname.match(/\/([^\/]+)\/mobile\/index\.html$/),d=c?c[1]:"";if(d){window.location.href="//"+a[0]+"/books/"+d+"/mobile/index.html"+(window.location.search+window.location.hash);return}}$("body").empty();$("body").attr("style","");$("body").css({display:"flex","flex-direction":"column","align-items":"center","justify-content":"center",background:"#ffffff",color:"#000000","text-align":"center","font-size":"20px"});$("body").append("<img alt='' style='width:98px;height:98px;' src='"+
uiBaseURL+"only-wechat.svg'/><p style='margin-top:35px;'>\u5185\u5bb9\u4e0d\u5b58\u5728</p>");return}}catch(e){}}}if(bookConfig.OnlyOpenInWechat||bookConfig.onlyOpenInDingDing)if(c=function(e){$("body").empty();$("body").attr("style","");$("body").css({display:"flex","flex-direction":"column","align-items":"center","justify-content":"center",background:"#ffffff",color:"#000000","text-align":"center","font-size":"20px"});$("body").append("<img alt='' style='width:98px;height:98px;' src='"+uiBaseURL+
"only-wechat.svg'/><p style='margin-top:35px;'>"+e+"</p>");$("body").removeAttr("id")},isDingDing()){if(!bookConfig.onlyOpenInDingDing){c("\u8bf7\u5728\u5fae\u4fe1\u5ba2\u6237\u7aef\u6253\u5f00\u94fe\u63a5");return}}else if(isWeChat()){if(!bookConfig.OnlyOpenInWechat){c("\u8bf7\u5728\u9489\u9489\u5ba2\u6237\u7aef\u6253\u5f00\u94fe\u63a5");return}}else{c(bookConfig.OnlyOpenInWechat?bookConfig.onlyOpenInDingDing?"\u8bf7\u5728\u5fae\u4fe1\u6216\u8005\u9489\u9489\u5ba2\u6237\u7aef\u6253\u5f00\u94fe\u63a5":
"\u8bf7\u5728\u5fae\u4fe1\u5ba2\u6237\u7aef\u6253\u5f00\u94fe\u63a5":"\u8bf7\u5728\u9489\u9489\u5ba2\u6237\u7aef\u6253\u5f00\u94fe\u63a5");return}bookConfig.OnlyOpenInIframe&&(window.parent===window.self||("Chinese"===UserGroups?0:NeatStyle.isNeat()||window.location.hash.includes("isOldNeat")))?($("body").empty(),$("body").attr("style",""),$("body").css({background:"#ffffff",color:"#000000","text-align":"center","font-size":"20px"}),$("body").append("<main role='main' style='text-align:center;'><img alt='' style='margin-top:45px;width:98px;height:98px;' src='"+
uiBaseURL+"only-wechat.svg'/><h1 style='margin-top:35px;margin-bottom:0;font-size:20px;font-weight:normal;line-height:1.4;'>"+bookConfig.OnlyOpenInIframeInfo+"</h1></main>")):initStage()}else alert(getLanguage("msgConfigMissing","Configuration file is missing, unable to open the book.")),function(){window.location=window.location.href}.delay(500)}
