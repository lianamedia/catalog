...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(x,u){return"function"==typeof x?function(t){try{m(x(t))}catch(r){p(r)}}:u}var m,p,q=new f(function(x,u){m=x;p=u});this.callWhenSettled_(l(h,m),l(k,p));return q};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
p){function q(t){return function(r){x[t]=r;u--;0==u&&m(x)}}var x=[],u=0;do x.push(void 0),u++,d(l.value).callWhenSettled_(q(x.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
f.parameters.zoomFlag=!1;f.parameters.zoomOut=!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,p=0,q=0;f.animateInterval=function(x,u){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,f.parameters.height*
(g-1),20);p=$.easing.swing(null,m,f.parameters.left,f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);q=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:q+"px"});for(var t=0;t<f.side.pageArray.length;t++)if(f.side.pageArray[t])f.side.pageArray[t].onResize(k/2,l);m++;if(20<=m||x>=u){f.animateInterval.stop();
...
100;var p=e*h,q=e*k,x=0,u=0,t=0,r=0;toolBar&&(x=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,u=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,t=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,r=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var v=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-r;l=-l-h*e*d.parameters.zoomArea.left/100+t}else v=-l-h*e*d.parameters.zoomArea.left/100+t,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-
r;q>windowHeight?(h=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-u,d=-m-k*e*d.parameters.zoomArea.top/100+x):(h=-m-k*e*d.parameters.zoomArea.top/100+x,d=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-u);g=Number.between(g,v,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
...
$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,q){m(p,q,"Sine")}).animation(this,300)}.bind(this),m=function(p,q,x){if(p<q){x=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,q);var u=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,q);p=k(null,p,this.parameters.scale,d-this.parameters.scale,q);q={};q.scale=
p;q.tran={x:x,y:u};x=transformCSS(q);this.css(x)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),p=getHost();if(m&&p!==m){if(g=f.src.replace(m,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(r){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var q=h.getImageData(0,0,k,l),x=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&q){var u=Color(b).split();k=0;for(var t=q.data.length;k<t;k+=4)0<x.data[k+3]&&(q.data[k]!=u.r&&(x.data[k]=q.data[k]/255*u.r),q.data[k+1]!=u.g&&(x.data[k+1]=
q.data[k+1]/255*u.g),q.data[k+2]!=u.b&&(x.data[k+2]=q.data[k+2]/255*u.b));h.putImageData(x,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(r){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(v){}})}}}}};
...
!0;m=new Date;t=(m-l)/20;var r=h-f,v=k-g;0==t?u=x=0:(x=r/t,u=v/t);void 0!=b&&b(x,u);window.clearInterval(p);p=-1}var f,g,h,k,l,m,p=-1,q=!1,x=0,u=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(t){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(t){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",p=-1,q,x,u,t=k.length-l;++p<t;)q=k.charCodeAt(p)<<
16,x=k.charCodeAt(++p)<<8,u=k.charCodeAt(++p),q=q+x+u,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q&63);2==l?(q=k.charCodeAt(p)<<8,x=k.charCodeAt(++p),q+=x,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<2&63)+"="):1==l&&(q=k.charCodeAt(p),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,p,q,x="",u=-1;++u<l;)q="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(u)),
p=m%4?64*p+q:q,m++%4&&(x+=String.fromCharCode(255&p>>(-2*m&6)));return x},version:"0.1.0"};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return g});else if(c&&!c.nodeType)if(d)d.exports=g;else for(var h in g)g.hasOwnProperty(h)&&(c[h]=g[h]);else b.base64=g})(this);function parsHexToNormalString(b){for(var c="";2<=b.length;)c+=String.fromCharCode(parseInt(b.substring(0,2),16)),b=b.substring(2,b.length);return c}
...
8*u.length))}function p(u,t){var r=l(u),v=[],z=[];v[15]=z[15]=void 0;16<r.length&&(r=h(r,8*u.length));for(u=0;16>u;u+=1)v[u]=r[u]^909522486,z[u]=r[u]^1549556828;t=h(v.concat(l(t)),512+8*t.length);return k(h(z.concat(t),640))}function q(u){var t="",r;for(r=0;r<u.length;r+=1){var v=u.charCodeAt(r);t+="0123456789abcdef".charAt(v>>>4&15)+"0123456789abcdef".charAt(v&15)}return t}function x(u,t,r){t?r?u=p(unescape(encodeURIComponent(t)),unescape(encodeURIComponent(u))):(u=p(unescape(encodeURIComponent(t)),
unescape(encodeURIComponent(u))),u=q(u)):u=r?m(unescape(encodeURIComponent(u))):q(m(unescape(encodeURIComponent(u))));return u}"function"===typeof define&&define.amd?define(function(){return x}):"object"===typeof module&&module.exports?module.exports=x:b.md5=x})(this);String.prototype.MD5=function(b){return md5(this)};
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d",{willReadFrequently:!0});l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var p=m.getImageData(0,0,l.width,l.height),q=p.data,x=c?e(c):null,u=d?e(d):{r:0,g:0,b:0,a:0},t=0;t<q.length;t+=4){var r=q[t+3];0===r?(q[t]=u.r,q[t+1]=u.g,q[t+2]=u.b,q[t+3]=void 0!==u.a?u.a:0):0<r&&255>r?x&&(q[t]=Math.round((x.r*r+u.r*(255-r))/255),q[t+1]=Math.round((x.g*r+u.g*(255-r))/255),q[t+2]=Math.round((x.b*r+u.b*(255-r))/255),
q[t+3]=255):x&&(q[t]=x.r,q[t+1]=x.g,q[t+2]=x.b,q[t+3]=void 0!==x.a?x.a:255)}m.putImageData(p,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}var getRandomColor=function(){return"#"+Math.floor(1118481+14540253*Math.random()).toString(16)};function normalizeUrl(b){return b&&"string"===typeof b?b.replace(/\\\//g,"/"):b}
...
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(q,x){var u=c();try{var t=x&&"object"===typeof x?Object.assign({},x):x;if(t&&"object"===typeof t){t.page=Number(q+1);var r=u[q];r&&r.positions&&t.positions?t.positions=r.positions.concat(t.positions):r&&r.positions&&(t.positions=r.positions);null!=l?t.realPage=Number(l):r&&r.realPage&&(t.realPage=r.realPage);r&&Object.keys(r).forEach(function(v){"page"===v||"realPage"===v||"positions"===
v||v in t||(t[v]=r[v])})}u[q]=t;return!0}catch(v){return console.error("writeToTarget error",v),!1}}function e(q,x,u){if(!q||0===q.length)return null;for(var t=q[0].left,r=q[0].top,v=q[0].right,z=q[0].bottom,A="",F=0;F<q.length;F++){var D=q[F];t=Math.min(t,D.left);r=Math.min(r,D.top);v=Math.max(v,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=t/x;r/=u;v/=x;u=z/u;u=[F,u,v,u,v,r,F,r];z=[];for(F=0;F<q.length;F++)z.push(q[F].width/x);if(!A||0===A.trim().length)return null;q=u.concat(z);return{w:A,p:q}}
function f(q){b._pageReaderExtracted||(b._pageReaderExtracted={});q=Array.isArray(q)?q:[q];for(var x=0,u=0;u<q.length;u++){var t=q[u];if(t&&!(1>t)&&!b._pageReaderExtracted[t])if(b._pageReaderExtracted[t]=!0,window._getPage&&"function"===typeof window._getPage)try{var r=window._getPage(t-1);if(r){var v=null;if(r.items&&Array.isArray(r.items)){v=r.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<v.length;D++){var L=v[D];if(L&&"text"===L.type&&
...
la)}else console.warn("PageTextExtractor: window._getPage \u65b9\u6cd5\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u63d0\u53d6\u6587\u672c\u914d\u7f6e")}return x}function g(q){var x,u,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(!q||1>q)return r.return(!1);b._positionScriptLoaded||(b._positionScriptLoaded={});b._positionScriptLoadPromises||(b._positionScriptLoadPromises={});x=b.getSearchRealPageIndex(q);if(0>=x||-1===x||b._positionScriptLoaded[x])return r.return(!1);if(u=b._positionScriptLoadPromises[x])return r.return(u);
t=function(){var v,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.setCatchFinallyBlocks(2,3),v=String.format(bookConfig.searchPositionJS,x),1<x&&(v=v.replace("[1]","["+x+"]")),z=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi,A=/\.*\/?(\w+\/)*\w+?\.js/gi,v.match(z)||v.match(A)?D.yield(getArticleImage(fixURLValue(v)),5):D.return(!1);case 5:return(v=D.yieldResult)?D.yield(h(q,v,x),6):D.return(!1);case 6:return b._positionScriptLoaded[x]=!0,D.return(!0);
case 3:D.enterFinallyBlock();delete b._positionScriptLoadPromises[x];D.leaveFinallyBlock(0);break;case 2:return F=D.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),D.return(!1)}})}();b._positionScriptLoadPromises[x]=t;return r.return(t)})}function h(q,x,u){var t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){t=function(){var v,z,A,F,D,L,M,I;return $jscomp.asyncExecutePromiseGeneratorProgram(function(G){switch(G.nextAddress){case 1:k=q;l=u;if(v=
...
l=null,m=Promise.resolve(),p=new Proxy({},{get:function(q,x){var u=c();return"string"===typeof x&&/^\d+$/.test(x)?u[Number(x)]:"length"===x?u.length:"function"===typeof Array.prototype[x]?Array.prototype[x].bind(u):q[x]},set:function(q,x,u){return"string"===typeof x&&/^\d+$/.test(x)?(q=Number(x),null!=k?d(k-1,u):d(q,u),!0):!1},has:function(q,x){var u=c();return"string"===typeof x&&/^\d+$/.test(x)?Number(x)in u:x in q},ownKeys:function(){var q=c();return Object.keys(q).concat(Object.getOwnPropertyNames(Object.prototype))},
getOwnPropertyDescriptor:function(q,x){var u=c();return"string"===typeof x&&/^\d+$/.test(x)?{configurable:!0,enumerable:!0,value:u[Number(x)],writable:!0}:Object.getOwnPropertyDescriptor(q,x)}});"undefined"!==typeof window?Object.defineProperty(window,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:p}):"undefined"!==typeof b&&Object.defineProperty(b,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:p});"undefined"!==typeof b&&null==b._positionScriptLoadPromises&&
(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(q){var x,u,t,r,v,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),x=Array.isArray(q)?q:[q],u=[],t=!1,r=0;case 2:if(!(r<x.length)){D.jumpTo(4);break}v=x[r];if(!v||1>v){D.jumpTo(3);break}z={pageIndex:v,hasText:!1,
...
b.hasPageText=function(q){b.pageTextPositions||(b.pageTextPositions=[]);var x=!Array.isArray(q),u=[],t=!1;q=$jscomp.makeIterator(x?[q]:q);for(var r=q.next();!r.done;r=q.next())if(r=r.value,!r||1>r)x||u.push({pageIndex:r,hasText:!1,positionCount:0});else{var v={pageIndex:r,hasText:!1,positionCount:0},z=r-1;(z=c()[z])&&z.page===r&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(v.hasText=!0,v.positionCount=z.positions.length,t=!0);if(x)return v.hasText;u.push(v)}return{hasText:t,pageResults:u}};
...
e.contributions[m]||{};null!=p.topReq&&(k=Math.max(k,b(p.topReq,k)));null!=p.bottomReq&&(l=Math.max(l,b(p.bottomReq,l)))}if(c()){var q=b(global.staticAd.height,90),x=parseInt(global.staticAd.adPosition);2===x&&(k=Math.max(k,g+q+20));1===x&&(l=Math.max(l,h+q+20))}tmpBookConfig.topMargin=k;tmpBookConfig.bottomMargin=l;var u=e.lastApplied.topMargin!==tmpBookConfig.topMargin||e.lastApplied.bottomMargin!==tmpBookConfig.bottomMargin;e.lastApplied.topMargin=tmpBookConfig.topMargin;e.lastApplied.bottomMargin=
...
function checkFliphtml5PagesConfig(){var b,c,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:b=window.htmlConfig.fliphtml5_pages;if("string"!==typeof b){window.fliphtml5_pages=b;k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(new Promise(function(l,m){setTimeout(function(){try{var p=allocateUTF8(b),q=Module._DeString(p),x=UTF8ToString(q);Module._FreeMemory(q);if(x&&"undefined"!==x){q=x;var u=q.lastIndexOf("]");0<u&&(q=q.substring(0,
...
UserGroups?".yunzhan365.com":".fliphtml5.com")+";path=/")}function d(){for(var l={},m=window.location.search.substring(1).split("&"),p=0;p<m.length;p++){var q=m[p].split("="),x=decodeURIComponent(q[0]);q=q[1]?decodeURIComponent(q[1]):null;l[x]=q}return l}function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){var m=16*Math.random()|0;return("x"===l?m:m&3|8).toString(16)})}try{var f=b("first_visit_channel_source");if(!f||!f.uuid){var g=e(),h={channel:"",referer:document.referrer,
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026080501",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
x=0;x<canvasData[b].resources.length;x++)if(1!=canvasData[b].resources[x].type)q++,q>=canvasData[b].resources.length&&k();else{var u=new Image;u.src=getResource(b,x);u.alt="";globalImages[b][x]=u;u.onload=function(){q++;q>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(u){bookConfig.largePageWidth/bookConfig.largePageHeight>u[0].naturalWidth/u[0].naturalHeight?u.css({width:"auto",height:"100%"}):u.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)p=c[m],p=p.removeStartFrom("?"),q=$("<img alt='' style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),q.attr("src",p),k.append(q),q[0].onload=function(u){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},q[0].onerror=function(u){h++;h==c.length&&
e&&e(c,c,k,b)};x.jumpToEnd()})},noneLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){h=$("<div style='width:100%;height:100%;background:"+bookConfig.pageBackgroundColor+";'></div>");e&&e(c,c,h,b);return k.return()})},jsLoad=function(b,c,d,e,f,g){var h,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){h=function(q,x){return!q||passwardType()&&bookConfig.excludeFrontPages&&x>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),p.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),m=$("<img alt='' src='"+l+"'/>"),m[0].onload=function(){e&&e(l,c,this,b)},p.return();loadJavascript(c,function(q){var x=dataBase64Str(b,d,q);$("<img alt='' src='"+x+"'/>")[0].onload=function(){e&&e(x,c,this,b)}},
function(){});return p.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(!window.printLoadStack)return p.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;m=new PdfLoadingTask(b,d,k,l,function(q){var x=q.toDataURL("image/png"),u=$("<img alt='' src='"+x+"'/>");u[0].onload=function(){e&&e(x,x,u,b)}}.bind(h));window.printLoadStack.push(m);return p.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
function(){this.create(b,c,d)}.bind(h),function(){}),q.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return m=dataBase64Str(b,c),h.$image=$("<img alt='' src='"+m+"'/>"),h.$image[0].onload=function(){d&&d(m,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),q.return();p=h;loadJavascript(k,function(x){var u=dataBase64Str(b,c,x);p.$image=$("<img alt='' src='"+
...
this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),ImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));m.imageURL=
...
function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);bookConfig.textSharpening&&(q="-webkit-optimize-contrast",_agent_.browser.firefox&&(q="-moz-crisp-edges"),_agent_.browser.opera&&(q="-o-crisp-edges"),m.$image.css({"image-rendering":q,"-ms-interpolation-mode":"nearest-neighbor"}));x.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&
...
function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,x){if(!b)return!1;var u=b.pageWidth,t=b.pageHeight,r=$.easing["easeInOut"+x],v=$.easing["easeOut"+x];x=v(null,p,g,b.toPoint.x-g,q);v=v(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(x=r(null,p,g,b.toPoint.x-g,q),v=bookConfig.FlipDirection?f*Math.sqrt(t*t-x*x):t-f*Math.sqrt(u*u-x*x));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:v}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",
...
var IssuuImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));m.imageURL=p;m.imageObject=new ImageObject;m.imageObject.alt(m.index);
m.imageObject.src(m.imageURL);m.imageObject.css({"z-index":0});m.$image=m.imageObject.$image;bookConfig.EnableRecognizeQRcodePressOnMobile&&m.imageObject.css({"-webkit-touch-callout":"default"});m.loaded=!1;m.$image[0].onload=function(){this.loaded=!0;this.callback&&this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(m);m.$image[0].onerror=function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);
bookConfig.textSharpening&&(q="-webkit-optimize-contrast",_agent_.browser.firefox&&(q="-moz-crisp-edges"),_agent_.browser.opera&&(q="-o-crisp-edges"),m.$image.css({"image-rendering":q,"-ms-interpolation-mode":"nearest-neighbor"}));x.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&isPC()?this.switchNormalImage(b,c):(isPhone()||isPad())&&this.resize()},
...
c,this.width,this.height),this.scale(b.x,b.y)}}),IssuuImageArrayLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,m,p,q,x;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(1==u.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,h.callback=d,h.$images=[],h.loadArray=[],u.yield(getPageDir(b,c,originTotalPageCount),2);k=u.yieldResult;h.imagesURL=k;l=
0;m=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);p=function(t){l++;this.$images.removeElement(t);this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);for(q=0;q<k.length;q++)x=-1<k[q].indexOf(".svg")?new IssuuImageArrayLoadSvg(b,k[q],c,m,p,e,f,g,q):new IssuuImageArrayLoadImage(b,k[q],c,m,p,e,f,g,q),h.$images.push(x.$image),h.loadArray.push(x);u.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&
...
l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,x){if(!b)return!1;var u=b.pageWidth,t=b.pageHeight,r=$.easing["easeInOut"+x],v=$.easing["easeOut"+x];x=v(null,p,g,b.toPoint.x-g,q);v=v(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(x=r(null,p,g,b.toPoint.x-g,q),v=bookConfig.FlipDirection?f*Math.sqrt(t*t-x*x):t-f*Math.sqrt(u*u-x*x));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:v}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){try{var m=1,p=1;m=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);for(c=0;c<b.length;c++){var q=this.pageArray[b[c]];if(q){var x=transformCSS({tran:l?l:{x:0,y:0},scale:{x:m,y:p},origin:g});this.isCoverPage(b[c])&&(q.tran=l?l:{x:0,y:0},q.scale=
{x:m,y:p},q.rotateY?(q.$page[0].style.removeProperty("transform-origin"),d=void 0,x=transformCSS({scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})):(d=void 0,x=transformCSS({origin:g,scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})));q.setCSSByStyle(x);if(q.page.pageFlipShadow){var u=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});q.page.pageFlipShadow&&q.page.pageFlipShadow.setCSSByStyle(u)}}}return{x:m,y:p}}catch(t){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},
...
1,d);q=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(u){if(u){var t=transformCSS({tran:l?l:{x:0,y:0},scale:{x:p,y:q},origin:g});if(m.isCoverPage(u.pageIndex))if(u.tran=l?l:{x:0,y:0},u.scale={x:p,y:q},u.rotateY){u.$page[0].style.removeProperty("transform-origin");var r;t=transformCSS({scale:{x:p,y:q},perspective:6E3,rotateY:null!=(r=u.rotateY)?r:0})}else{var v;t=transformCSS({origin:g,scale:{x:p,y:q},perspective:6E3,rotateY:null!=(v=u.rotateY)?v:0})}u.setCSSByStyle(t);t=h?transformCSS({scale:{x:k.x/
p,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});u.page.pageFlipShadow&&u.page.pageFlipShadow.setCSSByStyle(t)}};for(d=0;d<b.length;d++){var x=this.pageBackArray[b[d]];c(this.pageArray[b[d]]);c(x)}return{x:p,y:q}}catch(u){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&
...
function validateDomainAccess(b){function c(){try{window.__bookDomainAccessDenied=!0}catch(e){}$("body").empty().removeAttr("style");$("body").css({background:"#ffffff",color:"#000000","text-align":"center","font-size":"20px"}).append($("\n        <main role='main' class='domain-access-box' style='text-align:center;'>\n          <img alt='' style='margin-top:45px;width:98px;height:98px;' src='"+bookConfig.UIBaseURL+"style/icon/only-wechat.svg'/>\n          <h1 style='margin-top:35px;margin-bottom:0;font-size:20px;font-weight:normal;line-height:1.4;'>"+bookConfig.OnlyOpenInIframeInfo+
"</h1>\n        </main>\n      "))}b=void 0===b?5E3:b;if(window.location.href.includes("book_edit")||!(bookConfig.OnlyOpenInIframe&&bookConfig.domainAccess&&bookConfig.domainAccess.length&&window.parent!=window.self&&bookConfig.enableDomainAccess)||"undefined"!==typeof BookPreviewPublic)return!0;try{if(document.referrer){try{var d=new URL(document.referrer)}catch(e){d=null}if(d&&-1<d.hostname.indexOf("fliphtml5")&&-1<d.pathname.indexOf("/bookcase/")||-1<document.referrer.indexOf("/bookcase/")&&-1<
document.referrer.indexOf("fliphtml5"))return!0}}catch(e){}return new Promise(function(e){function f(){var m=[];"string"===typeof bookConfig.domainAccess?m=bookConfig.domainAccess.replace(/\\n/g,"\n").split(/[,;\n\r]+/).map(function(p){return p.trim()}):Array.isArray(bookConfig.domainAccess)&&(m=bookConfig.domainAccess.map(function(p){return p.trim()}));return m.map(function(p){return g(p)}).filter(function(p){return p})}function g(m){return m.replace(/^https?:\/\//,"").split(":")[0].split("/")[0].toLowerCase()}
function h(m){return f().some(function(p){return p===g(m)})}function k(m){m.data&&"PARENT_DOMAIN"===m.data.type&&(clearTimeout(l),window.removeEventListener("message",k),h(m.origin)&&h(m.data.domain)?e(!0):(c(),e(!1)))}var l=setTimeout(function(){var m=document.referrer;m?h(m)?e(!0):(c(),e(!1)):e(!0)},b);window.addEventListener("message",k)})};Class("Item",{Package:"PageItem",create:function(b,c,d,e){this.parent=b;this.config=this.parseConfig(c);this.pageWidth=d;this.pageHeight=e;this.pw=d;this.ph=e;this.type=this.config.annotype},parseConfig:function(b){return b},animateConfig:function(){this.config.animation&&this.config.animation.name&&(this.config.animation.duration||(this.config.animation.duration=1),this.config.animation.timeFun||(this.config.animation.timeFun="ease"),this.config.animation.delay||(this.config.animation.delay=0),this.config.animation.count||
...
(function(b){function c(h,k){h=h.querySelectorAll("canvas");var l=k.querySelectorAll("canvas"),m=[];h.forEach(function(p,q){var x=l[q];if(x){x.width=p.width;x.height=p.height;p=p.toDataURL();var u=new Image;q=new Promise(function(t){u.onload=function(){x.getContext("2d").drawImage(u,0,0);t()};u.onerror=function(){return t()}});u.src=p;m.push(q)}});return Promise.all(m).then(function(){})}var d=0,e={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},f={};b.fn.printArea=function(h){b.extend(f,e,h);d++;b("[id^=printArea_]").remove();f.id="printArea_"+d;var k=b(this),l=g.getPrintWindow();g.write(l.doc,k);c(b(this)[0],l.doc).then(function(){function m(){q&&q();g.print(l)}var p=b(l.doc).find("img"),q=h&&"function"===typeof h.onReady?h.onReady:null;if(0===p.length)m();else{var x=0;p.each(function(u,t){if(t.complete)x++,x===p.length&&m();else b(t).on("load error",function(){x++;x===p.length&&
